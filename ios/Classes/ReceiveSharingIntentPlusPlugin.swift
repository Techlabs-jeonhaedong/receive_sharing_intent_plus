...
public class SwiftReceiveSharingIntentPlusPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
    static let kMessagesChannel = "receive_sharing_intent_plus/messages"
    static let kEventsChannelMedia = "receive_sharing_intent_plus/events-media"
    static let kEventsChannelLink = "receive_sharing_intent_plus/events-text"

    private var customSchemePrefix = "ParotShare"
    ...
    // -> see Example app
    public static let instance = SwiftReceiveSharingIntentPlusPlugin()
    ...
    // - found the issue while developing multiple applications using this library, after "application(_:open:options:)" is called, the first app using this library (first app by bundle id alphabetically) is opened
